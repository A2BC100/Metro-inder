...
public class RealtimeController {
    ...
    @GetMapping("/station")
    @ResponseBody
    public ResponseEntity<Object> getRealtimeStation(@RequestParam("stationName") String station) throws Exception {
    ...
    @GetMapping("/weather")
    @ResponseBody
    public ResponseEntity<Object> getRealtimeWeather(@RequestParam ("lat")double lat,@RequestParam("lon") double lon,@RequestParam("date")String date,@RequestParam("time")String time) throws Exception {
